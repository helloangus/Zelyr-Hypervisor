...
| P1-W05 | [EL2 exception entry baseline detailed implementation design](p1-w05-el2-exception-entry-baseline/README.md) and [implementation record](p1-w05-el2-exception-entry-baseline-record.md) | W11 NC3/NC5 synchronous pairs passed locally; NC6 unexpected-vector execution remains blocked |
...
| P1-W11 | [Negative and fault validation detailed implementation design](p1-w11-negative-fault-validation/README.md), [implementation record](p1-w11-negative-fault-validation-record.md) and [local verification](../verification/p1-w11-negative-fault-validation-verification.md) | NC1–NC5 pairs and S1–S6 review passed locally; NC6 genuine unexpected event blocked, so P1-V18 and P1 stage remain open |

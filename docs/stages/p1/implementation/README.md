...
| P1-W08 | [Host Stage-1 address space detailed implementation design](p1-w08-host-stage1-address-space/README.md), [table foundation](p1-w08-stage1-foundation-record.md), and [page-layout record](p1-w08-page-layout-record.md) | Table model and linker layout checked; MMU transition pending |

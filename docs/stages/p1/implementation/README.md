...
| P1-W07 | [Fatal crash diagnostics detailed implementation design](p1-w07-fatal-crash-diagnostics/README.md) and [implementation record](p1-w07-fatal-crash-diagnostics-record.md) | In progress; W09 lifecycle foundation and target/fault validation pending |

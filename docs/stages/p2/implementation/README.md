...
|---|---|---|
| P2-W01 | [Boot platform-description intake detailed implementation design](p2-w01-boot-platform-description-intake/README.md) | Proposed design; implementation not claimed |
| P2-W02 | [Platform discovery and normalization detailed implementation design](p2-w02-platform-discovery-normalization/README.md) | Proposed design; implementation not claimed |
